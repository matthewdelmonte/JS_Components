...
if(isset($_POST["submit"]))
{
    ...
    {
        $error .= '<p><label class="text-dange">Message is required</label></p>';
    }
    else
    {
...
<head>
    ...
    <title>Form Data to CSV File</title>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstratp/3.3.6/css/bootstrap.min.css" />
